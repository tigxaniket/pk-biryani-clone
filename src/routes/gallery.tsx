...
import chickenThaliAsset from "@/assets/gallery-chicken-thali.avif.asset.json";
const chickenThali = chickenThaliAsset.url;
import paneerAsset from "@/assets/gallery-paneer.avif.asset.json";
const paneer = paneerAsset.url;
