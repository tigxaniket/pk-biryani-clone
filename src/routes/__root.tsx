...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "चव मराठमोळ्या जेवणाची घरगुती पद्धतीने काळा मसाल्यात बनवलेल मटण, चिकन आणि अंडा थाळी." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "hotel chul jatra" },
      { property: "og:description", content: "चव मराठमोळ्या जेवणाची घरगुती पद्धतीने काळा मसाल्यात बनवलेल मटण, चिकन आणि अंडा थाळी." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "hotel chul jatra" },
      { name: "twitter:description", content: "चव मराठमोळ्या जेवणाची घरगुती पद्धतीने काळा मसाल्यात बनवलेल मटण, चिकन आणि अंडा थाळी." },
